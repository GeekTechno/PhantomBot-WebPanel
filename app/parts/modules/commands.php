...
$defaultCommands = array_unique(array_merge($defaultCommands, array_keys($commandPriceIni), array_keys($commandCooldown)));
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">
        ...
        <?= $templates->moduleActiveIndicator($functions->getModuleStatus('customCommands.js')) ?>
      </h3>
    </div>
      ...
      <div class="collapsible-content">
        <div class="row">
          <div class="col-sm-4">
            ...
            <?= $templates->botCommandForm('permcom', 'Permissions', '[command] [group]') ?>
            <?= $templates->botCommandForm('cooldown', 'Cooldown', '[command] [seconds]') ?>
          </div>
        </div>
      </div>
      <hr/>
