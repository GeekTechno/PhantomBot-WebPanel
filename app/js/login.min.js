$(document).ready(function () {
  ...
  $("#login-form").submit(function (event) {
    login({username: $("#login-username").val(), password: SparkMD5.hash($("#login-password").val(), false)});
    event.preventDefault()
  })
});
function login(loginData) {
  $.ajax({
    type: "POST", url: "app/php/login.php", data: loginData, dataType: "json", success: function (data) {
      if (data[1] == 200) {
